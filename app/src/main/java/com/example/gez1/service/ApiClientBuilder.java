...
public class ApiClientBuilder {
    public static final String BASE_URL = "https://gez-mobile-app.000webhostapp.com";
    ...
    public static ApiClient getAnkaraClient() {
        return getClient().create(ApiClient.class);
    }

    public static ApiClient getIzmirClient() {
        return getClient().create(ApiClient.class);
    }
